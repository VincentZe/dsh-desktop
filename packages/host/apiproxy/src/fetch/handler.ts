...
import {
  ...
  workspaceTrashSessionRequestSchema,
...
const UNARY_ROUTES: UnaryRoutes = {
  ...
  'workspace.trashSession': { schema: workspaceTrashSessionRequestSchema, invoke: (api, r) => api.workspace.trashSession(r) },
  'workspace.restoreSession': { schema: workspaceTrashSessionRequestSchema, invoke: (api, r) => api.workspace.restoreSession(r) },
  'workspace.deleteTrashedSession': { schema: workspaceTrashSessionRequestSchema, invoke: (api, r) => api.workspace.deleteTrashedSession(r) },
