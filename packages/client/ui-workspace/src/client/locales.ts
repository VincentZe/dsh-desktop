...
export const zh = {
  ...
  'menu.selectSession': '选择会话',
  'menu.deselectSession': '取消选择',
  'menu.deleteSession': '删除会话',
  'menu.deleteSelected': '删除所选会话',
  'menu.restoreSession': '恢复会话',
  'menu.deleteForever': '永久删除',
  'select.sessions': '选择会话',
  'select.exit': '退出选择',
  'select.all': '全选',
  'select.count': '已选择 {n} 个会话',
  'select.session.aria': '选择会话“{name}”',
  'delete.selected': '删除所选会话',
...
export const en = {
  ...
  'menu.selectSession': 'Select session',
  'menu.deselectSession': 'Deselect session',
  'menu.deleteSession': 'Delete session',
  'menu.deleteSelected': 'Delete selected sessions',
  ...
  'select.count': '{n} sessions selected',
  'select.session.aria': 'Select session {name}',
  'delete.selected': 'Delete selected sessions',
