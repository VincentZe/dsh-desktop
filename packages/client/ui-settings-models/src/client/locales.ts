...
export const en = {
  ...
  modelReasoningMode: 'Reasoning handling',
  modelReasoningAdjustable: 'Selectable effort',
  modelReasoningProviderDefault: 'Provider default only',
  addModel: 'Add model',
  ...
  modelReasoningInvalid: 'Reasoning handling must be selected from the available options.',
...
export const zh: { [Key in keyof typeof en]: string } = {
  ...
  modelAdvanced: '高级设置',
  modelReasoningMode: '思考模式适配',
  modelReasoningAdjustable: '支持思考强度调节',
  modelReasoningProviderDefault: '使用提供方默认思考',
  addModel: '添加模型',
  removeModel: '删除模型',
  ...
  modelReasoningInvalid: '思考模式适配必须选择可用选项。',
